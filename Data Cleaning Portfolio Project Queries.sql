...
Select SaleDateConvertedConverted, CONVERT(Date,SaleDateConverted)
From ProjectDB.dbo.NashvilleHousing
...
Add SaleDateConvertedConverted Date;

Update NashvilleHousing
SET SaleDateConvertedConverted = CONVERT(Date,SaleDateConverted)
